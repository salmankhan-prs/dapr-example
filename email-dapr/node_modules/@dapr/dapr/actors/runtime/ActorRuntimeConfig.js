...
class ActorRuntimeConfig {
     ...
     */
    constructor(actorIdleTimeout = polyfill_1.Temporal.Duration.from({ hours: 1 }), actorScanInterval = polyfill_1.Temporal.Duration.from({ seconds: 30 }), drainOngoingCallTimeout = polyfill_1.Temporal.Duration.from({ minutes: 1 }), drainRebalancedActors = true) {
