...
class HTTPServerActor {
    ...
    handlerHealth(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return res.send("ok");
        });
    }
    handlerConfig(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const actorRuntime = ActorRuntime_1.default.getInstance(this.client.getDaprClient());
            const result = Object.assign({ entities: actorRuntime.getRegisteredActorTypes() }, actorRuntime.getActorRuntimeConfig().toDictionary());
