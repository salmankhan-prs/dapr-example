...
class HTTPClient {
    constructor(host = Settings_util_1.Settings.getDefaultHost(), port = Settings_util_1.Settings.getDefaultHttpPort(), options = {}) {
        ...
        if (this.options.isKeepAlive) {
            this.httpAgent = new http_1.default.Agent({ keepAlive: true, keepAliveMsecs: 30 * 1000 });
            this.httpsAgent = new https_1.default.Agent({ keepAlive: true, keepAliveMsecs: 30 * 1000 });
        }
        else {
    ...
    _startAwaitSidecarStarted() {
        return __awaiter(this, void 0, void 0, function* () {
            yield __1.DaprClient.awaitSidecarStarted(() => __awaiter(this, void 0, void 0, function* () { return yield sidecar_1.default.isStarted(this); }));
        });
    }
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
